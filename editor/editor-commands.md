...
- chart 전환 시 스택 초기화(잠정 — [[editor-graph]] §4 잔여).
...
잔여:
- [ ] chart 구조 커맨드(chart 추가/삭제/복제/chartId 편집)의 scope — n/s/m 어디에도 안 속함. 신설 scope 여부·undo 시 스택 복원 여부와 함께 보류(토의, [[editor-graph]] §4)
