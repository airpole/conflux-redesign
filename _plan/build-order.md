...
| M1-5 | [[judge]] Hold 소유 — Normal 익명 수요, Wide 단일 소유·이양, tail release grace, head MISS 2단위 | 동시 Hold 시나리오에서 소유가 원자적으로 이양된다. grace 50ms 안 release는 SYNC, 밖은 MISS. head MISS가 score·게이지 2단위를 즉시 확정한다. |
